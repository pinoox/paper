...
class TemplateHelper
{
    ...
    public static function setFooter($key, $value)
    {
    ...
    public static function initData()
    {
        ...
        $header_code = setting('developer.header_code');
        $footer_code = setting('developer.footer_code');
        ...
        self::setHead('header_code', $header_code);
        self::setFooter('footer_code', $footer_code);
    }
