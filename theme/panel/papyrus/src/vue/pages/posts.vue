          ...
          <div class="section-content">
            <vue-good-table
              ...
              <template slot="table-row" slot-scope="props">
                ...
                <div v-else-if="props.column.field === 'approx_date'">
                                <span class="light" v-if="props.row.status === 'schedule'">
                                  {{ props.row.approx_schedule_date }}
                                </span>
                  <span class="light" v-else>
                                  {{ props.row.approx_date }}
                                </span>
                </div>
                ...
                <div v-else>
                                <span
                                    :class="typeof props.column.style === 'function'? props.column.style(props.row) : props.column.style">
                                  <i v-if="!!props.column.icon" :class="props.column.icon"></i> <span
                                    v-html="props.formattedRow[props.column.field]"></span>
                                </span>
                </div>
              </template>
              <div slot="emptystate">
  ...
  computed: {
    columns() {
      return [
        ...
        {
          label: this.LANG.post.date_release,
          field: 'approx_date',
          style: 'light',
        },
        {
