...
<head>
    ...
    <meta property="og:description" content="<?php echo @$_description; ?>"/>
    <meta property="og:url" content="<?php echo url(); ?>"/>
    <meta property="og:image" content="<?php echo $_url; ?>dist/paper/images/icon-paper.png"/>
    <meta property="og:site_name" content="<?php echo $_title ?>"/>
...
<script src="<?php echo $_url; ?>dist/paper/<?php echo @$assets['vendor_js']; ?>"></script>
<script src="<?php echo $_url; ?>dist/paper/<?php echo @$assets['main_js']; ?>"></script>
</body>
</html>