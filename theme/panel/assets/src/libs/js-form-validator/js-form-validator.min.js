...
(function (q) {
    ...
    m.prototype = {
        messages: {
            ...
            fa: {
                required: {empty: "این فیلد نباید خالی باشد", incorrect: "مقدار نامعتبر است"},
                notzero: {empty: "Please make a selection", incorrect: "مقدار نامعتبر است"},
                integer: {
                    empty: "یک مقدار عدد صحیح وارد کنید",
                    incorrect: "عدد صحیح وارد شده  نامعتبر است"
                },
                "float": {empty: "یک مقدار اعشاری وارد کنید", incorrect: "عدد اعشاری وارد شده نامعتبر است"},
                min: {empty: "مقدار بیشتری وارد کنید", incorrect: "مقدار بیشتری وارد کنید"},
                max: {empty: "مقدار کمتری وارد کنید", incorrect: "مقدار کمتری وارد کنید"},
                between: {empty: "مقدار بین {0}-{1} وارد کنید", incorrect: "مقدار بین {0}-{1} وارد کنید"},
                name: {empty: "لطفا نام را وارد کنید", incorrect: "نام وارد شده صحیح نیست (حداقل 3 حرف باشد)"},
                lastname: {empty: "لطفا نام خانوادگی را وارد کنید", incorrect: "نام خانوادگی وارد شده نامعتبر است"},
                phone: {empty: "لطفا شماره موبایل را وارد کنید", incorrect: "شماره موبایل وارد شده نامعتبر است"},
                email: {empty: "ایمیل را وارد کنید", incorrect: "ایمیل وارد شده نامعتبر است"},
                length: {
                    empty: "حداقل {0} کاراکتر و حداکثر {1}",
                    incorrect: "حداقل {0} کاراکتر و حداکثر {1}"
                },
                minlength: {
                    empty: "باید حداقل {0} کاراکتر باشد",
                    incorrect: "مقدار وارد شده کمتر از {0} کاراکتر است"
                },
                maxlength: {
                    empty: "باید حداکثر {0} کاراکتر باشد",
                    incorrect: "مقدار وارد شده بیشتر از {0} کاراکتر است"
                },
                maxfilesize: {
                    empty: "سایر فایل و یا فایل های انتخاب شده بیشتر از {0} {1}",
                    incorrect: "سایر فایل و یا فایل های انتخاب شده بیشتر از {0} {1}"
                },
                fileextension: {empty: "فایلی انتخاب کنید", incorrect: "فایل و یا فایل های انتخاب شده نامعتبر است"}
            }
        },
        rules: {
            required: function (a) {
